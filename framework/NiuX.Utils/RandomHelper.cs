...
public static class RandomHelper
{
    ...
    public static string Letters = @"0123456789abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZ";
    ...
    public static IEnumerable<char> GetChars(int count)
    {
        lock (Rnd)
        {
            return Enumerable.Range(0, count).Select(_ => Letters[Rnd.Next(0, Letters.Length)]);
        }
    }
